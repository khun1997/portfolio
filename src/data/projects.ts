...
export const projects: Project[] = [
  {
    ...
    tech: ["Next.js", "TypeScript", "React Query", "Stripe", "Tailwind CSS", "Zustand"],
    category: "Web App",
  ...
  },
  {
    ...
    description: "Real-time weather forecasts with beautiful data visualizations.",
    longDescription:
    ...
    tech: ["Next.js", "TypeScript", "Chart.js", "OpenWeather API", "Geolocation API"],
    category: "Dashboard",
  ...
  },
  {
    ...
    description: "Drag-and-drop tool for creating personalized developer portfolios.",
    longDescription:
  ...
  },
  {
    ...
    tech: ["React", "TypeScript", "WebSocket", "Tailwind CSS", "Zustand", "Vite"],
    category: "Web App",
